...
\begin{code}
bracketObserveIO :: Config.Configuration -> Trace IO a -> Severity -> LoggerName -> STM.STM t -> IO t
...
\begin{code}
bracketObserveLogIO :: Config.Configuration -> Trace IO a -> Severity -> LoggerName -> STM.STM (t,[(LOMeta, LOContent a)]) -> IO t
